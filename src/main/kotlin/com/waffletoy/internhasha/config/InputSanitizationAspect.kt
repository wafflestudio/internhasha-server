...
class InputSanitizationAspect {
    @Around("(execution(* com.waffletoy.internhasha..*(..)) && @within(org.springframework.web.bind.annotation.RestController)) || @within(org.springframework.stereotype.Service)")
