...
class InputSanitizationAspect {
    @Around("(execution(* com.wafflestudio.internhasha..*(..)) && @within(org.springframework.web.bind.annotation.RestController)) || @within(org.springframework.stereotype.Service)")
